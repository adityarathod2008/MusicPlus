...
pyinstaller --noconfirm --onefile --windowed --icon "icon.ico" --add-data "backend;backend" --add-data "js;js" --add-data "music_app.html;." --add-data "style.css;."  "desktop_app.py"
